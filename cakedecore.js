...
(function () {
    ...
    INC.config.noimage = "https://www.increasingly.co/Clients/c70k34o7s/images/no-image.png";
    // ------------------------
    ...
    // let currentCurrency = document.querySelector("meta[property='og:price:currency']").getAttribute('content')
                ...
                switch (INC.config.pageType) {
                    case "pdp":
                        ...
                        if(mainProd.ProductType == "simple"){
                            ...
                            //if(window.location.href == "https://www.thecakedecoratingcompany.co.uk/black-friday-c489/cake-lace-gold-pump-push-edible-glitter-dust-10g-p3953"){
    ...
    INC.methods.createAMBlock = function (PDP_type) {
        if (INC.dataStore.dataStoreObj.undefined == undefined) {
            ...
            // setTimeout(function () {
            //     var all_list_el = document.querySelectorAll('.inc_af_product-list_block .inc_product_modal_block')
            //     for (var all_list in all_list_el) {
            //         if (Object.prototype.hasOwnProperty.call(all_list_el, all_list)) {
            //             var prd_moduleb = all_list_el[all_list].parentNode
            //             var main_idsd = ""
                ...
                if (INC.config.pageType == "pdp") {
                    if (Object.keys(productObj).length == 0 || client_add_btn == "client_add_btn" || client_add_btn == "clientbtn") {
                        if (elmparent != null) {
                            ...
                            //                 ".inc_pdp_product-main_block .inc_product_img_main_img img") != null) {
                            //                 var imgselp = "";
                            ...
                            //                 }
                            //                 var namep = elmparent.querySelector(".product-add-to-cart__inner h2").innerText.trim();
                            ...
                            //                     clientPrice = document.querySelector(".product-add-to-cart__inner .price-wrap .sale-price").innerText.replace("£", "")
                            //                         .replace(",", "");
                            //                 }
                            //                 if (elmparent.querySelector(".price-wrap").classList.contains("on-sale")) {
                            //                     clientPrice = document.querySelector(".product-add-to-cart__inner .price-wrap .original-price").innerText.replace("£",
                            //                         "").replace(",", "");
                            //                     clientSpPrice = document.querySelector(".product-add-to-cart__inner .price-wrap .sale-price").innerText.replace("£", "")
                            //                         .replace(",", "");
                            //                 }
                            ...
                            //                     if (document.querySelector(".inc_just_added_save_pr") != null) {
                            //                         document.querySelector(".inc_just_added_save_pr").innerText = "Save:" + formatter.format(Math.abs(
                            //                             sidebarsavepr));
                            //                     }
                            //                 }
                            //                 let swatches1;
                            ...
                            //                     }
                            //                     productBlock.querySelector(".inc_cart_added_product_desc_title_text").innerText = capitalizeFirstLetter(namep
                            //                         .toLowerCase());
                            //                     productBlock.querySelector(".inc_cart_added_product_desc_title_text").setAttribute("title", capitalizeFirstLetter(
                            //                         namep));
                            //                     if (parseFloat(clientSpPrice) != null && parseFloat(clientSpPrice) < parseFloat(clientPrice)) {
                            //                         productBlock.querySelector(".inc_cart_added_product_desc_ecirp_active_text").innerHTML = formatter.format(
                            //                             clientSpPrice);
                            //                     } else {
                            //                         productBlock.querySelector(".inc_cart_added_product_desc_ecirp_active_text").innerHTML = formatter.format(
                            //                             clientPrice);
                            ...
                            //                             productBlock.querySelector(".inc_cart_added_product_desc_att_size_text").innerHTML = "colour: " + color_
                            //                                 .toLowerCase() + " , " + "size: " + size_.toLowerCase();
                            //                         } else {
                            //                             productBlock.querySelector(".inc_cart_added_product_desc_att_size_text").innerHTML = "size: " + size_
                            //                                 .toLowerCase();
                            //                         }
                            //                     }
                            //                 }
    ...
    function prepareAdditionalimages(elImgGalleryListBlock, productObj, productBlock) {
        ...
        // otherImages = otherImages.filter((item,
        //     index) => otherImages.indexOf(item) === index);
    ...
    INC.methods.createProductShowcaseBlock = function (pdpProductId, blockType, _bundleProductListCheck, _parentblock, elProductShowcaseBlock, mainprod) {
        ...
        // Set Pretext
        // If single attribute & not selected then FROM
    ...
    function eladdfn_(productModuleBlock) {
        if (productModuleBlock.querySelector(".inc_product_variant_simple_text.simple") != null) {
            ...
            // productModuleBlock.querySelector('.inc_product_variant_simple_text').textContent = "Please select option";
            // productModuleBlock.querySelector('.inc_product_variant_simple_text').setAttribute('title','Please select option')
        }
    ...
    function productcoloratt(productColorsObj, productBlock, elAttColorListBlock, blockType, elAttColorBlock, elAttColorTitleText, bType) {
        ...
        if (productColorsObj.colorArray.length > 0) {
            ...
            if (productColorsObj["colorArray"].length > 0) {
                ...
                // elAttColorTitleText.innerText = blockType != "pdp" ? productColorsObj["colorArray"][0].label : productColorsObj["colorArray"][
                // 0].label + ": ";
                if (blockType == "pdp" || blockType == "sidebar") {
                    if (productBlock.parentNode.classList == 'inc_product_showcase_block') {
    ...
    function colorelmOb(colorObj, elAttColorListBlock, colorC, blockType, productBlock, one_attr_flag, bType) {
        ...
        attColorImgBlock.addEventListener("click", function () {
            // if(productBlock.parentNode.classList == 'inc_product_showcase_block'){
            //     if(window.innerWidth < 768){
            //         productBlock.querySelector(".inc_product_variant_simple_block").click()
            //     }else{
            //         productBlock.querySelector(".inc_product_img_main_block a").click()
            //     }
            // }else{
    ...
    function productsizeatt(elAttSizeTitleText, elAttSizeBlock, productSizesObj, elAttSizeListBlock, elAttSizeTitleTextSelected, blockType,productBlock) {
        if (productSizesObj.sizeArray.length > 0) {
            ...
            if (productSizesObj["sizeArray"][0].code != "Color") {
                ...
                // elAttSizeTitleText.innerText = blockType != "pdp" ? productSizesObj["sizeArray"][0].label : productSizesObj["sizeArray"][0].label + ": ";
    ...
    INC.methods.mappvariants = function (obj, blocktype, type_of_variant) {
        if (obj.parentNode != undefined) {
            ...
            // if(window.innerWidth > 820){
            //     setTimeout(function(){
            //         if(productblockshow.querySelector('.inc_product_variant_simple_text').innerText == "Please select option"){
    ...
    INC.methods.updateProductBlock = function (productBlockel, findObj, blockType) {
        ...
        if (Object.keys(productObj).length != 0) {
            ...
            //         }
            //         var PrdVarSimTxt = productBlock.querySelector(".inc_product_variant_simple_text");
            //         var colorTitle = generate_html_tag("div", 'inc_colortile');
            //         colorTitle.addEventListener("click", function (e) {
            //             e.preventDefault();
            //         });
            //         if (ccode) {
            //             colorTitle.style.backgroundColor = ccode;
            //             PrdVarSimTxt.innerHTML = "";
            //             PrdVarSimTxt.appendChild(colorTitle);
            //             PrdVarSimTxt.innerHTML = PrdVarSimTxt.innerHTML + "<span>" + sel_attr_text + "</span>";
            //             colorTitle.classList.add("colorBox");
            //         }
	                ...
	                try {
	                    ...
	                    if (void 0 !== e.error)
	                        ...
	                        if (
	                            ...
	                            //     attribute_summary: r.product_attribute_summary,
	                            //     product_thumbmini: r.product_thumbmini,
	                            //     price: r.product_price,
	                            //     basket_quantity: e.basket_num_items
	                            // });
	                            ...
	                            // void 0 !== t && t && (void 0 !== ProductSettings.loaded_via_quickbuy && 1 == ProductSettings.loaded_via_quickbuy ? (window.document.location.href = "/basket",
	                            // window.close) : window.location.href = "/basket")
	                        }
	                        // void 0 !== Product.storage.hideBuyNowButtonWhenBasketHasProducts && Product.storage.hideBuyNowButtonWhenBasketHasProducts && e.basket_num_items > 0 && $("#js-buy-now-button").hide(),
            ...
            try {
                ...
                if (clickedElement.parentNode) {
                    ...
                    if (clickedElement.classList == "attributes-select") {
                        //updateClientToBundleSize(clickedElement.options[clickedElement.selectedIndex].text,"label")
                        updateClientToBundleSize(clickedElement,"label")
                    }
